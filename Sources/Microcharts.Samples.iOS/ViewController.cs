...
namespace Microcharts.Samples.iOS
{
        public partial class ViewController : UIViewController
        {
                ...
                private void Reload(object sender, EventArgs e)
                {
                        ...
                        CreateChartCard(new RadarChart { Entries = entries, LineAreaAlpha = areaAlpha, PointMode = PointMode.Square, PointSize = pointSize, LineSize = lineSizeSlider.Value, LineMode = lineMode, MaxValue = entries.Max(x => Math.Abs(x.Value) + 100) });
